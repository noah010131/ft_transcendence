...
const friend_invite_service_1 = require("./friend-invite.service");
...
exports.MatchmakingModule = MatchmakingModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [matchmaking_service_1.MatchmakingService, friend_invite_service_1.FriendInviteService],
        exports: [matchmaking_service_1.MatchmakingService, friend_invite_service_1.FriendInviteService],
    })
], MatchmakingModule);
